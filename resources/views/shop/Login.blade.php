						...
						<form action="" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    ...
						    <div class="remember">
							   ...
							   <link href="{{app('shop_css')}}/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" />
							   <link href="{{app('shop_css')}}/fb&gp_btns.css" rel="stylesheet" type="text/css" media="all" />
